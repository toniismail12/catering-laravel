        ...
        <section id="form-pemesanan" class="book-a-table">
            <div class="container" data-aos="fade-up">
                ...
                <div class="section-header">
                    <p> <span class="text-black">Form Upload Bukti Transfer</span> </p>
                </div>

                <form action="/kirim-pembayaran" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="row g-0 d-flex align-items-center reservation-form-bg p-3">
                        ...
                        <div class="col-lg-12 " data-aos="zoom-out" data-aos-delay="200">
                            <div class="card p-3">
                                ...
                                <table class="table">
                                    ...
                                    <tr>
                                        <td><label for="">Pembayaran Untuk</label></td>
                                        <td>
                                    ...
                                    <tr>
                                        <td><label for="">Foto Bukti Transfer</label></td>
                                        <td>
                                            <input name="image" type="file" class="form-control" required />
                                            <small>Note: Format file jpg, jpeg, png.</small>
                                        </td>
                                    </tr>
                        ...
                        <div class="col-lg-12">
                            <div class="card p-3">
                                <button onclick="return confirm('Klik OK untuk melanjutkan.')" type="submit" class="btn btn-success">Kirim</button>
                            </div>
                        </div>
