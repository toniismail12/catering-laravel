        ...
        <section id="form-pemesanan" class="book-a-table">
            <div class="container" data-aos="fade-up">
                ...
                <div class="section-header">
                    <p> <span class="text-black">Sewa Alat Satuan</span> </p>
                </div>

                <form action="/simpan-pesan-alat-satuan" method="POST">
                    @csrf
                        ...
                        <div class="col-lg-12 reservation-img" data-aos="zoom-out" data-aos-delay="200">
                            <div class="card p-3">
                                ...
                                <table class="table">
                                    ...
                                    <tr>
                                        <td><label for="">Pilih Alat</label></td>
                                        <td>
                                            <ul style="list-style-type: none; margin: 0; padding: 0;">
                                                @foreach ($alat as $item)
                                                    <li>
                                                        <input name="alat[]" type="checkbox" value="{{ $item->id }}" /> {{ $item->nama_alat }} - Rp. {{ $item->biaya }}
                                                    </li>
                                                @endforeach
                                            </ul>
                                        </td>
