        ...
        <section id="form-pemesanan" class="book-a-table">
            <div class="container" data-aos="fade-up">
                ...
                <div class="section-header">
                    <p> <span class="text-black">Form Pemesanan Catering</span> </p>
                </div>
                ...
                <form action="/simpan-pesanan" method="POST">
                    @csrf
                    <div class="row g-0 d-flex align-items-center reservation-form-bg p-3">
                            ...
                            <div class="card p-3">
                                ...
                                <table class="table">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <select class="form-control" name="paket" required>
                                                ...
                                                <option value="{{ $item->uuid }}">Paket {{ $item->paket }} | {{ $item->kategori }}</option>
                                                @endforeach
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <input name="porsi" type="number" min="20" class="form-control" required value="20"/>
                                            <small>Info: Minimal 20 porsi</small>
                                        </td>
                                    </tr>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <small>Info: Minimal 3 hari setelah pemesanan.</small>
                                        </td>
                                    </tr>
                                    <tr>
                        ...
                        <div class="col-lg-12" data-aos="zoom-out">
                            <div class="card p-3">
                                <button onclick="return confirm('Apakah yakin ingin melanjutkan pemesanan?')" type="submit" class="btn btn-success">Pesan Sekarang</button>
                            </div>
                        </div>
