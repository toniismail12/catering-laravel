        ...
        <section id="login" class="book-a-table">
            <div class="container" data-aos="fade-up">
                ...
                <div class="section-header">
                    <p> <span class="text-black">Lupa Password</span> </p>
                </div>
                ...
                <div class="row g-0">
                    ...
                    <div class="col-lg-8 reservation-form-bg p-5">
                        ...
                        <form action="/lupa-password" method="post" data-aos="fade-up" data-aos-delay="100">
                            @csrf
                            <div class="row gy-3">
                            ...
                            <div class="text-center mt-3">
                                <button type="submit" class="btn btn-primary">Requst Lupa Password</button>
                            </div>
